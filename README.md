...
|  |                                                                               |  |
|  |   Pods get IPs from: 172.16.0.0 - 172.16.0.255 (Node Pod CIDR)                |  |
|  |                                                                               |  |
|  +-------------------------------------------------------------------------------+  |
|                                                                                     |
|  +-------------------------------------------------------------------------------+  |
...
|  |   vxlan.calico --> Calico VXLAN interface                                     |  |
|  |                                                                               |  |
|  |   Pods get IPs from: 172.16.1.0 - 172.16.1.255 (Node Pod CIDR)                |  |
|  |                                                                               |  |
|  +-------------------------------------------------------------------------------+  |
|                                                                                     |
|  +-------------------------------------------------------------------------------+  |
...
|  |   vxlan.calico --> Calico VXLAN interface                                     |  |
|  |                                                                               |  |
|  |   Pods get IPs from: 172.16.2.0 - 172.16.2.255 (Node Pod CIDR)                |  |
|  |                                                                               |  |
|  +-------------------------------------------------------------------------------+  |
|                                                                                     |
+-------------------------------------------------------------------------------------+
